...
plot_usmap(data = max_state_df, values = "disease", color = "black") + 
  ...
  theme(legend.position = "right")
```
The disease with most cases is not the most deadly, or is it? When looking at the dataset, we find that the death data for measles, for example, is missing. The solution for that, is to no use measles data when comparing the information from deaths.
